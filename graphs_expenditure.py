...
class ExpenditureVisualizer(BaseVisualizer):
    ...
    def create_graph2(self, df, lifestyle, per_capita=False):
        ...
        plt.xlabel(f'Total Expenditure (c3) {pop_type}')
        plt.ylabel('Value')
        plt.title(f'Total Expenditure vs Upper Poverty Line - {lifestyle.capitalize()} {pop_type}')
        plt.legend()
    ...
    def create_graph3(self, df, lifestyle, per_capita=False):
        ...
        plt.ylabel('Value')
        plt.title(f'Food Expenditure vs Food Norm - {lifestyle.capitalize()} {pop_type}')
        plt.legend()
    ...
    def create_graph4(self, df, lifestyle, per_capita=False):
        ...
        plt.ylabel('Value')
        plt.title(f'Poverty Lines Relationship - {lifestyle.capitalize()} {pop_type}')
        plt.legend()
