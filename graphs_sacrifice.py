...
class SacrificeVisualizer(BaseVisualizer):
    ...
    def create_graph5(self, df, lifestyle, per_capita=False, aggregation='mean'):
        ...
        plt.fill_between(range(len(sorted_sacrifice)),
                         sorted_sacrifice,
                         0, where=sorted_sacrifice < 0, color='red', alpha=0.1, label='Food Sacrifice')
    ...
    def create_graph6(self, df, lifestyle, per_capita=False, aggregation='mean'):
