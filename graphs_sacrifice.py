...
class SacrificeVisualizer(BaseVisualizer):
    def create_graph5(self, df, lifestyle, per_capita=False):
        ...
        plt.title(f'Household Food Sacrifice Distribution - {lifestyle.capitalize()} {pop_type}')
        plt.legend()
    ...
    def create_graph6(self, df, lifestyle, per_capita=False):
        ...
        plt.title(f'Expenditure Sacrifice Distribution - {lifestyle.capitalize()} {pop_type}')
        plt.legend()
