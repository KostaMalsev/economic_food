...
class VisualizationManager:
    def __init__(self, save_dir='./graphs/'):
        ...
        self.graph_mapping = {
            1: 'expenditure', 2: 'expenditure', 3: 'expenditure', 4: 'expenditure',
            5: 'sacrifice', 6: 'sacrifice',
            7: 'sufficiency', 8: 'sufficiency',
            9: 'detailed', 10: 'detailed',
            11: 'normalized', 12: 'normalized'
        }
    ...
    def generate_all_plots(self, df, lifestyles=None, per_capita_options=None):
        ...
        for lifestyle in lifestyles:
            ...
            for per_capita in per_capita_options:
                ...
                try:
                    for graph_num in range(5, 6): #1,13
                        ...
                        visualizer.save_plot(f'graph{graph_num}_{lifestyle}_{metric_type}')
